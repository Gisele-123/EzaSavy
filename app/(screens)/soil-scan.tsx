    ...
    <ScrollView style={styles.container}>
        ...
        >
          ...
          >
            <BlurView intensity={20} style={styles.optionContent}>
              ...
              <Text style={styles.optionDescription}>Take a photo of your soil</Text>
            </BlurView>
          </TouchableOpacity>
        </Animated.View>
        ...
        >
          ...
          >
            <BlurView intensity={20} style={styles.optionContent}>
              ...
              <Text style={styles.optionDescription}>Describe your soil characteristics</Text>
            </BlurView>
          </TouchableOpacity>
        </Animated.View>
        ...
        >
          ...
          >
            <BlurView intensity={20} style={styles.optionContent}>
              ...
              <Text style={styles.optionDescription}>Describe your soil verbally</Text>
            </BlurView>
          </TouchableOpacity>
        </Animated.View>
      </View>
      ...
      {scanMethod === 'text' && (
        ...
        >
          <TextInput
            style={styles.input}
            placeholder="Describe your soil (color, texture, moisture, etc.)"
          ...
          <TouchableOpacity 
            ...
            onPress={handleScan}
          >
            <Text style={styles.scanButtonText}>Analyze Soil</Text>
          </TouchableOpacity>
        </Animated.View>
      )}
